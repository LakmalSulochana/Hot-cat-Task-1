...
export default function Home() {
  return (
    <div className='flex flex-row  justify-center bg-[#FAFBFC] '>
      ...
      <MainPage/>
      <Profile cover={"bg-helthImg"} year={"2022"} topic={ "Health & Wellbeing of Our Family"} description={"A successful life is one that’s lived  to the fullest, and if there are obstacles in the form of illnesses, be prepared to afford the best care you deserve.Find out how much you'll need to look after your and support Dilu, Ruwan and Ruwani even in critical conditions."}/> 
